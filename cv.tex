...
I'm a systems engineer with a strong foundation in virtualization, linux, and confidential computing. I have strong interest in virtualization and its related fields. I have designed OpenTDX, which emulates Intel TDX based on QEMU/KVM, and GPU passthrough framework for AMD SEV-SNP VMs based on VFIO. Besides, I have several research experiences in security fields, including secure TEE IO using MK-TME and IOMMU, cross cache attacks in Linux kernel, secure AI training framework, etc.
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          {\href{https://github.com/sslab-gatech/open-tdx}{\textbf{\underline{Intel TDX Emulation on QEMU/KVM}}}}
          {Sep. 2024 -- Now}
      ...
      \resumeProjectHeading
          {\href{https://github.com/JaewonHur/sev-snp-gpu}{\textbf{\underline{Enabling GPU passthrough to AMD SEV-SNP VM}}}}
          {Aug. 2023 -- Dec. 2023}
        ...
        \resumeItemListStart
            ...
            \resumeItem
                {Used framework: QEMU, KVM, vfio, Linux, AMD-SEV}
        \resumeItemListEnd
