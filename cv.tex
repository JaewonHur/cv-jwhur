...
I have lots of research experiences across the full stack of computer systems. I enjoyed understanding, and refactoring an existing system into a security-oriented system using confidential computing. For example, I refactored current deep learning frameworks (e.g., PyTorch) into a new one for protecting training data, and I also initiated a new Apach Spark architecture for data protection in analysis (i.e., \textbf{DLBox} and \textbf{Secure Spark} presented at \textbf{NDSS 2025}). Furthermore, I also devised a new approach for confidential serverless computing, which drastically improves the latency and throughput (i.e., \textbf{TeeMate}). Not only on applications, but I also have deep knowledge on virtualization, building KVM-based emulation of Intel TDX. Pushing forward, I'm going to design a secure LLM serving system based on this emulation. This will lead to my next interest on the design and optimization of LLM serving system. Besides, I also have experiences on RTL, initiating and publishing several RTL fuzzing papers before (i.e., \textbf{DifuzzRTL} at \textbf{S\&P 2021} and \textbf{SpecDoctor} at \textbf{CCS 2022}). Experiences on bug findings (i.e., \emph{syzkaller} extension for SGX libOS, \textbf{FuzzOrigin}, and \textbf{R2Z2}) helped me deeply think about system bugs, and building secure systems.

\vspace{10pt}

Overall, with broad research experiences on computer systems, I believe I can quickly grasp, find, and solve the issues in emerging systems.
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        ...
        \resumeItemListStart
          ...
          \resumeItem
              {\href{https://github.com/sslab-gatech/open-tdx}{\underline{I gave a talk to Intel, open-sourcing OpenTDX}}}
        \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    {\item{
     \textbf{Languages}
     \begin{itemize}
      \item \textit{Knowledgeable:} {C, Python, Scala, Dart}
      \item \textit{Have an experience with:} {Go, C++, Kotlin, Java, TypeScript, Rust} \\
     \end{itemize}
     \textbf{Frameworks}{: AFL, syzkaller, QEMU, KVM, Spark, Docker, Kubernetes, Git, Linux, PyTorch, React} \\
    }}
\end{itemize}
