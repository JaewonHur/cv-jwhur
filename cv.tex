...
Systems researcher with deep expertise in kernel-level virtualization and security.
Published in S\&P, CCS, and NDSS.
Experienced in confidential computing (TDX, SEV), fuzzing (CPU, LibOS), and large-scale distributed systems (Spark, serverless).
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          {\href{https://github.com/sslab-gatech/open-tdx}{\textbf{\underline{Emulating Intel TDX Machines}}}}
          {Sep. 2024 -- May. 2025}
        ...
        \resumeItemListStart
          \resumeItem
              {Used language: C}
          \resumeItem
              {Used framework: Linux, KVM, QEMU}
          \resumeItem
              {Presented to Intel engineers, OpenTDX adopted internally}
        \resumeItemListEnd

      \resumeProjectHeading
          {\href{https://github.com/JaewonHur/dlbox}{\textbf{\underline{Building Secure Model Training Framework}}}}
          {Mar. 2022 -- Apr. 2023}
        ...
        \resumeItemListStart
            ...
            \resumeItem
                {\href{https://github.com/JaewonHur/sev-snp-gpu}{\underline{Normal GPU passthrough to SEV-SNP VMs}}}
        \resumeItemListEnd

      \resumeProjectHeading
          {\textbf{Building Secure Apache Spark}}
          {May. 2022 -- Dec. 2023}
      ...
      \resumeProjectHeading
          {\textbf{Building Efficient Confidential Serverless Computing}}
          {May. 2022 -- Dec. 2023}
      ...
      \resumeProjectHeading
        ...
        \resumeItemListStart
            ...
            \resumeItem
                {Used by Gramine LibOS team to find bugs}
        \resumeItemListEnd

      \resumeProjectHeading
          {\href{https://github.com/compsec-snu/specdoctor}{\textbf{\underline{Fuzzing CPU to find transient execution vulnerabilities}}}}
          {May. 2021 -- Dec. 2022}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    {\item{
     \textbf{Languages:}{C, Python, Scala, Dart, Go, C++, Kotlin, Java, TypeScript, Rust} \\
